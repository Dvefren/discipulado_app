...
import { createCourse, updateCourse, setActiveCourse, deleteCourse } from "@/app/actions/courses";
...
export default function CoursesPage() {
  ...
  async function handleFormSubmit(data: any) {
    if (data.courseId) { await updateCourse(data); } else { await createCourse(data); }
    fetchData();
  }
