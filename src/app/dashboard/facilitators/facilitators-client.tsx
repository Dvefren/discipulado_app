              ...
              {group.facilitators.map((f) => (
                <div key={f.id} className="bg-card border border-border rounded-xl p-3.5 hover:border-border transition-colors group">
                  <div className="flex items-center gap-2.5 mb-2.5">
                    <Link
                      href={`/dashboard/facilitators/${f.id}`}
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-[13px] font-medium text-foreground truncate flex items-center gap-1.5">
                          {f.name}
                          {!f.hasUser && (
                            <span className="text-[9px] px-1.5 py-0.5 rounded-full bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400 font-normal" title="Sin cuenta de usuario">
                              Sin cuenta
                            </span>
                          )}
                        </p>
